...
async function default_1(context, req) {
    ...
    try {
        ...
        context.log.info(`Neue Projektanfrage von "${inquiry.name}" <${inquiry.email}> für Bereich "${inquiry.projectType}".`);
    ...
    <div class="footer">
      MK Applications &bull; Markus Kaufmann &bull; Bielefeld &bull; Azure Static Web Apps
        ...
        `.trim();
            ...
            context.log.warn('Strato SMTP ist noch nicht vollständig konfiguriert (SMTP_USER oder SMTP_PASS fehlen in Azure App Settings).');
        }
        ...
        context.res = {
            ...
            body: JSON.stringify({
                success: true,
                message: 'Vielen Dank für Ihre Anfrage! Markus Kaufmann wird sich in Kürze persönlich bei Ihnen melden.',
                data: {
                    name: inquiry.name,
